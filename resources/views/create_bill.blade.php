...
@section('main')
    ...
    <div class="page-content">
        <form id="createpatientForm" action="{{ url('savebill') }}" method="Post" enctype="multipart/form-data">
            @csrf
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex justify-content-between">
                            <div>
                                <a href="{{ url('/home') }}" class="btn btn-primary"><i
                ...
                <div class="row  mt-4" style="position: relative;left: 49px;">
                    <div class="col-md-3  offset-md-8 pl-2">
                        <div class="d-flex justify-content-center align-items-center ">
                            <button type="button" class="btn btn-primary btn-font" id="save" disabled>
                                Save
                            </button>
                            <button class="btn btn-success mf-1 btn-font " type="button" id="saveAndPrint" disabled>Save &
                                Print</button>
                        </div>
                    </div>
                </div>
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        select.append('<option value="' + value.id + '" ' + (value.totalQuantity <= 0 ?
                                'disabled' : '') + '>' + value.name + ' (Stock ' + value
                            .totalQuantity + ')</option>');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        ...
                        const printStatus = response.print ===
                        "true"; // Convert string "true" or "false" to boolean
